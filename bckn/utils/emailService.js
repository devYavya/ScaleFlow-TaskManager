...
const sendInvitationEmail = async (email, name, tempPassword, role) => {
    try {
        ...
        const resetLink = `http://localhost:${process.env.PORT || 9040}/reset-password.html?email=${encodeURIComponent(email)}`;
...
const sendResetPasswordEmail = async (email, resetToken, name) => {
    try {
        ...
        const resetLink = `http://localhost:${process.env.PORT || 9040}/reset-password.html?token=${resetToken}&email=${encodeURIComponent(email)}`;
...
const sendWelcomeEmail = async (email, name) => {
    try {
        ...
        const mailOptions = {
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <div style="text-align: center;">
                                <a href="http://localhost:${process.env.PORT || 9040}" class="btn">🚀 Go to ScaleFlow</a>
                            </div>
            ...
            `,
            text: `Welcome to ScaleFlow!\n\nHello ${name},\n\nYour account has been activated.\n\nLogin at: http://localhost:${process.env.PORT || 9040}\n\nWhat you can do:\n- Create and manage tasks\n- Collaborate with team members\n- Track your progress\n- Add comments and reviews\n\nBest regards,\nScaleFlow Team`
        };
        ...
        const mailOptions = {
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    ...
                    <a href="http://localhost:${process.env.PORT || 9040}/developer" 
        ...
        const mailOptions = {
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px;">
                    ...
                    <hr>
                    <a href="http://localhost:${process.env.PORT || 9040}/admin" style="background: #6366f1; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Review Request</a>
                </div>
            `
        };
        ...
        const mailOptions = {
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px;">
                    ...
                    <hr>
                    <a href="http://localhost:${process.env.PORT || 9040}/developer" style="background: #6366f1; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">View Dashboard</a>
                </div>
            `
        };
